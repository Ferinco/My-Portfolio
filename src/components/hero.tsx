    ...
    return (
        <div className='sm:px-0 md:px-6 lg:px-8 xl:px-6 overflow-x-hidden overflow-y-hidden'>
            <div className="flex flex-col text-start">
                <div className="flex flex-col-reverse sm:flex-col text-start">
                ...
                <div className="flex flex-row items-end gap-9">
                    <h1 className="lg:text-[20rem] text-[7rem] sm:text-[8rem] md:text-[14rem] font-[500] sm:font-[700] lg:font-[900] tracking-normal lg:text-pretty md:text-balance text-wrap leading-none  lg:tracking-wide">Ferinco</h1>
