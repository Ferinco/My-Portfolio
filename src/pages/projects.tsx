...
<SubHeader title="Projects"/>
                <div className="mt-[70px]">
                    <div className="flex flex-row justify-between items-center">
                        ...
                        <p className="hidden lg:block text-start max-w-xl text-xl lg:text-2xl">5 featured</p>
                    ...
                    <div className="projects-body flex flex-col lg:gap-[100px] gap-[50px] mt-[70px]">
                        {
                            ProjectData.map((project, index) => (
                                <div className="flex flex-col">
                                    ...
                                    <div className={"flex flex-col justify-between items-end mt-5 lg:mt-9"}
                                        data-aos="fade-in"
                                        data-aos-delay={100}
                                        ...
                                        <div className="w-[100%] flex flex-row justify-between items-start mt-7">
                                            <div className="lg:w-[33%] w-auto"
                                                data-aos="fade-in"
                                                data-aos-delay={0}
                                                data-aos-easing="ease-in-sine">
                                                <h6 className={"text-start site-name lg:text-2xl"}>{project.title}</h6>
                                            </div>
                                            <div className="w-[33%] hidden lg:flex"
                                                data-aos="fade-in"
                                                data-aos-delay={100}
                                                data-aos-easing="ease-in-sine">
                                                <p className={" text-start text-lg font-medium text-black"}>{project.about}</p>
                                            </div>
                                            <div className={"flex flex-row items-center justify-center gap-5 lg:w-[33%] w-auto"}
                                                data-aos="fade-in"
                                                data-aos-delay={150}
                                                data-aos-easing="ease-in-sine">
                                                {
