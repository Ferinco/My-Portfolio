        ...
        <div className='flex flex-col px-3 md:px-6 lg:px-8 xl:px-14 mt-[150px]'>
            <div className="flex flex-col">
                <div className="flex flex-row justify-between py-12 border-t-2 border-gray-200 flex-wrap gap-y-6 lg:gap-0">
                    ...
                    <div className="flex flex-col text-start lg:w-[40%] md:w-[60%]">
                        <p className="text-start text-2xl">
                            I'm currently seeking a full-time position but I am also available for gigs and freelance work. Send me an email to hire me, and let's create something amazing together.                        </p>
