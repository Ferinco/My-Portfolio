            ...
            <div className="flex flex-col">
                <div className="flex flex-row justify-between py-12 border-t-2 border-gray-200 flex-wrap gap-y-6 lg:gap-0">
                    ...
                    <div className="flex flex-col text-start lg:w-[40%] md:w-[60%]">
                        ...
                        I'm currently seeking a full-time position but am also available for gigs and freelance work. Send me an email to hire me, and let's create something amazing together.                        </p>
